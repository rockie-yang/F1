...
grouped as (
  select driver_id,
         driver_full_name,
         count(*) as races,
            COUNT(CASE WHEN position_order BETWEEN 1 AND 3 THEN 1 END) as podiums,
            COUNT(CASE WHEN grid_position_order = 1 THEN 1 END) as pole_positions,
--             countif(grid_position_order = 1) as pole_positions,
--             countif(fastest_lap = 1) as fastest_laps,
